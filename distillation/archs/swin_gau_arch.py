...
class GLU(nn.Module):
    ...
    def __init__(self, in_features,hidden_features=None, out_features=None, activation='relu'):
        super().__init__()
...
class WindowGatedAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.fc1 = nn.Linear(dim, dim) # get u
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.attn = WindowGatedAttention(
            dim,
        ...
        glu_hidden_dim = int(dim * GLU_ratio)
        self.glu = GLU(in_features = dim, hidden_features = glu_hidden_dim, activation=GLU_activation)
    ...
    def forward(self, x, x_size):
        ...
        x = x + self.drop_path(self.glu(self.norm2(x)))
    ...
    def flops(self):
        ...
        # glu
        flops += 3 * h * w * self.dim * int(self.dim * self.glu_ratio) + h * w * int(self.dim * self.glu_ratio) # match mlp_ratio=2
        # norm2
        flops += self.dim * h * w
        return flops
...
class RSTB(nn.Module):
    ...
    def __init__(self,
        ...
        if resi_connection == '1conv':
            ...
            self.conv = nn.Sequential(
                nn.Conv2d(dim, dim, 3, 1, 1, groups=dim), nn.LeakyReLU(negative_slope=0.2, inplace=True),
                nn.Conv2d(dim, dim, 1, 1, 0), nn.LeakyReLU(negative_slope=0.2, inplace=True),
            )
...
class SwinIR_GAU(nn.Module):
    ...
    def __init__(self,
                 ...
                 resi_connection='1conv',
                 **kwargs):
        super(SwinIR_GAU, self).__init__()
        num_in_ch = in_chans
        num_out_ch = in_chans
        num_feat = 64
